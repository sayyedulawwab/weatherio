...
function App() {
  ...
  return (
    <div className="bg-gray-800 flex items-center justify-center w-screen min-h-screen h-full py-10">
      <div className="flex w-3/4 min-h-screen rounded-3xl shadow-lg m-auto bg-gray-100">
        {/* form card section  */}
